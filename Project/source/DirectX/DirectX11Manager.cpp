...
#include "./DeviceGetter.h"

namespace mslib {
namespace directx {
/*DirectX11Manager::DirectX11Manager(HWND hWnd, bool fullscreen) {
	//				(　2019/09/05　)
	//-----------よくわかってないゾーン-------------
	//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	static mslib::directx::DeviceGetter m_dget(m_device);
	static mslib::directx::DeviceContextGetter m_dcget(m_device_context);
